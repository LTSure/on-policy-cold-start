...
PROMPT_DATA="${PROMPT_DATA:-${PROJECT_ROOT}/data/alfworld_sft.json}"
OUTPUT_DIR="${OUTPUT_DIR:-${PROJECT_ROOT}/checkpoints}"
RUN_NAME="${RUN_NAME:-$(basename "${MODEL_NAME}")_opc_sft_alfworld}"
