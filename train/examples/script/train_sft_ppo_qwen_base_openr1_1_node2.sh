...
RUN_NAME="${MODEL_NAME}_ppo_sft_alfworld_muti_turn——0629_2"


# # llama3.2-3B,alfworld muti turn 0629_3
...
# llama3.2-3B,alfworld muti turn 0629_2
deepspeed --include localhost:0,1,2,3,4,5,6,7 --module openrlhf.cli.train_sft_ppo \
    --pretrain $MODEL \
    --save_path $HOME/checkpoints/$RUN_NAME \
    --micro_train_batch_size 1 \
...
# llama3.2-3B,alfworld muti turn 0629
deepspeed --include localhost:0,1,2,3,4,5,6,7 --module openrlhf.cli.train_sft_ppo \
    --pretrain $MODEL \
    --save_path $HOME/checkpoints/$RUN_NAME \
    --micro_train_batch_size 1 \
