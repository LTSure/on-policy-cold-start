...
def parse_args():
    ...
    parser.add_argument("--output_dir", type=str, default="qwen3_30b/ppo/2")
    ...
    parser.add_argument("--max_tokens_per_call", type=int, default=6000)
...
def main():
    ...
    # print(f'32132321:{args.seed} sdsad {args.temperature} 5656{args.shuffle}')
    ...
    for example in examples:
        ...
        # format_input = [{"role": "system", "content": SYSTEM_PROMPT}, {"role": "user", "content": SYSTEM_PROMPT + "\n\n"+ question}]
        format_input = [{"role": "user", "content": question + "\n\n"+ SYSTEM_PROMPT}]

        # chat_prompt = tokenizer.apply_chat_template(
        #     format_input, tokenize=False, add_generation_prompt=True, enable_thinking=True)
        chat_prompt = tokenizer.apply_chat_template(
