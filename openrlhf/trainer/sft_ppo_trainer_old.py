        ...
        if not self.without_ppo:
            ...
            if self.dft_baseline:
                ...
                if self.save_step_probs:
                    ...
                    # Use the full action mask to avoid dimension mismatch
                    valid_mask = experience.action_mask.contiguous()  # (B, T)
                    
                    # Reshape prob_coefficients to match the full mask shape
